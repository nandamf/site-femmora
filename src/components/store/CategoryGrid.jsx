  ...
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
        {CATEGORIES.map((cat) => (
          <a key={cat.name} href="#produtos" className="group relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 text-center">
              <h3 className="font-display text-xl md:text-2xl text-alabaster">{cat.name}</h3>
              <span className="inline-block mt-1 text-[10px] tracking-[0.2em] uppercase text-alabaster/80 border-b border-alabaster/40 pb-0.5">
                Comprar
              </span>
            </div>
          </a>
